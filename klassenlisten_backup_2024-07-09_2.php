...
foreach($result_berufe as $berufe) {
    ...
    if (!empty($result_ber)) {
        $beruf_anz = $result_ber[0]['langform'];
        $beruf_anz_kurz = substr($result_ber[0]['langform'], 0, 5);
        ...
        WHERE papierkorb NOT LIKE '1' AND beruf_anz LIKE '$beruf_anz_kurz%' AND beginn > '2024-07-31'
