...
$f_schulform = $_SESSION['f_schulform'];
...
echo "<p><b>".$treffer_an." Schülerdatensätze</b> in CSV-Datei geschrieben:<br></p>";
...
if ($_SESSION['admin'] == 1) {
echo "<div style='margin-top: 3em; padding: 3px; border: 2px solid grey;'>Wenn Sie auf Ihrem Server <i>python3</i> installiert haben, können Sie die Excel-Datei direkt herunterladen.
<p>Setzen Sie dafür in der Datei <i>config.php</i> die Variable <i>xls_download</i> von 0 auf 1.<br>
Außerdem sollten Sie ggf. die Ausführung des Skriptes ./export/main.py auf der Linux-Konsole testen. Dort werden ggf. Fehlermeldungen zu noch benötigten und zu installierenden Python-Modulen angezeigt.</p></div>";
}
?>
