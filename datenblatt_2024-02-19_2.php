			...
			echo "</td></tr>";
				...
				//Wenn es noch weitere Anmeldungen gibt:
					...
					echo "<tr'><td colspan='2' style='padding: 20 5 5 5; color: red;'><b>Speichern und Unterlagen ggf. auch hier prüfen:</b><br></td></tr>";
						...
						foreach($select_bil_dub as $bild_dub) {
							if ($bild_dub['prio'] != "") {
								echo "<tr><td colspan='2' style='padding: 5;'><a href='./datenblatt.php?id=".$bild_dub['id_dsa_bewerberdaten']."&tab=5'>Anmeldung für <b>".strtoupper($bild_dub['schulform'])."</b> - Priorität <b>".$bild_dub['prio']."</b></a></td></tr>";
							} else {
