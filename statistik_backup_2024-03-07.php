...
<body>
    <h1 style='margin-bottom: 2em;'>Anmeldungen im Vergleich zum Vorjahr</h1>
...
// Datenbankabfrage
$query = "SELECT time, schulform FROM dsa_bildungsgang WHERE (time >= '$neujahr' AND (prio <= 1) AND (schulform NOT LIKE 'bs' OR beginn > '2024-07-31'))";
$stmt = $db->query($query);
...
function erstelleWochenReihenfolge() {
    $wochen = array_merge(range(1, 25), range(1, 25));
    return $wochen;
