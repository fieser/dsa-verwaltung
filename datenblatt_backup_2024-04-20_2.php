			  ...
			  echo "<tr'><td style='padding: 5;'><b>Name Ausbilder/-in</b></td>			
				...
				//Wenn es noch weitere Anmeldungen gibt:
					...
					echo "<tr'><td style='padding: 20 5 5 5; color: red;'><b>Weitere Anmeldungen:</b></td></tr>";
						...
						if ($sum_prio != "") {
								echo "<tr><td style='padding: 5;'><a href='./datenblatt.php?id=".$bild_dub['id_dsa_bewerberdaten']."'>Anmeldung für <b>".strtoupper($bild_dub['schulform'])."</b> - Priorität <b>".$sum_prio."</b></td></tr>";
							} else {
			  ...
			  if ($bil['schulform'] == "bvj") {
				...
				//Wenn es noch weitere Anmeldungen gibt:
					...
					echo "<tr'><td style='padding: 20 5 5 5; color: red;'><b>Weitere Anmeldungen:</b></td></tr>";
						...
						if ($sum_prio != "") {
								echo "<tr><td style='padding: 5;'><a href='./datenblatt.php?id=".$bild_dub['id_dsa_bewerberdaten']."&tab=3'>Anmeldung für <b>".strtoupper($bild_dub['schulform'])."</b> - Priorität <b>".$sum_prio."</b></td></tr>";
							} else {
...
$directory = 'dokumente/unpacked'; // Verzeichnis, in dem die PDFs gespeichert sind.
...
if (!empty($filteredFiles)) {
    ...
    foreach ($filteredFiles as $file) {
        $filePath = htmlspecialchars($directory . '/' . $file); // Pfad zur Datei
        echo "<li><a href='$filePath' target='_blank'>$file</a></li>"; // Erstellen eines Links in einer Liste
    }
    echo "</ul>";
} else {
...
echo "<table>";
//echo "<tr><td>&nbsp;</td></tr>";
echo "<tr><td style='min-width: 3em;'><b>An:g</b></td><td style='max-width: 60em;'>".$bew['mail']." <small><i>(Schüler/-in)</i></small></td></tr>";
echo "<tr><td>&nbsp;</td></tr>";
